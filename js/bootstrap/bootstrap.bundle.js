...
(function($){
    ...
    $(document).ready(function() {
        ...
        var header             = $('.header'),
            ...
            portion_carousel = $('.portion-carousel'),
        ...
        $(document).on('click', '.inner-navigation.show', function(e) {
            if ( $(e.target).is('span') && !$(e.target).parent().parent().hasClass('menu-category-items') ) {
                $(this).collapse('hide');
            }
        });
        ...
        $('.side-canvas-open, .side-canvas-close').on('click', function() {
            $('body').toggleClass('side-canvas-sidebar-open');
            return false;
        }).resize();

        $(document).on('click', function(e) {
            var container = $('.side-canvas-sidebar');
            if (!container.is(e.target) && container.has(e.target).length === 0) {
                $('body').removeClass('side-canvas-sidebar-open');
            }
        }).resize();
        ...
        $('.side-canvas-sidebar-wrapper').css('margin-right', '-' + getScrollBarWidth() + 'px');
        ...
        portion_carousel.each(function () {
            $(this).owlCarousel($.extend({
                nav:      1,
                dots:     0,
                autoplay: 1,
